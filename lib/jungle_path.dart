...
class JungleAudio extends StatefulWidget {
  @override
  _JungleAudio createState() =>  _JungleAudio();

}

class _JungleAudio extends State<JungleAudio> {
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("NagiMusicAssets/picture2.jpg"),
              fit: BoxFit.cover,
              )
          ),
          child: 

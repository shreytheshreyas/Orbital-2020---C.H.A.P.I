...
class OceansAudio extends StatefulWidget {
  @override
  _OceansAudio createState() =>  _OceansAudio();

}

class _OceansAudio extends State<OceansAudio> {
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("NagiMusicAssets/picture3.jpg"),
              fit: BoxFit.cover,
              )
          ),
          child: 
